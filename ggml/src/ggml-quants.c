...
// PTQ1_0 trit-walk stage sizes (see quantize_row_ptq1_0_ref / dequantize_row_ptq1_0)
...
// PTQ1_0: PrismML packed-trit ternary, 5 trits/byte in qs[] (staged 32/16/8),
// 4 trits/byte in qh[], one fp16 scale per 128 weights. Mirror of the PrismML
// fork's reference codec (ggml-quants.c @ 9a9394a).
